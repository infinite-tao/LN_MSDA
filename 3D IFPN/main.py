...
if __name__ == '__main__':
    ...
    parser.add_argument("--fold", type=int, help='0,1,2 or 3')
    parser.add_argument('--data_root', default='/home/ubuntu/zhangyongtao/3D IFPN/Gastric_data/preprocessed_data',
    ...
    out_path = "/home/ubuntu/zhangyongtao/3D IFPN"
